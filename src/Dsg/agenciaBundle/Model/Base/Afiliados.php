...
use Dsg\agenciaBundle\Model\Map\AfiliadosTableMap;
...
abstract class Afiliados implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Dsg\\agenciaBundle\\Model\\Map\\AfiliadosTableMap';
    ...
    /**
     * Initializes internal state of Dsg\agenciaBundle\Model\Base\Afiliados object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Dsg\agenciaBundle\Model\Afiliados The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Dsg\\agenciaBundle\\Model\\Afiliados'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Dsg\agenciaBundle\Model\Afiliados
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Dsg\agenciaBundle\Model\Afiliados The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Dsg\agenciaBundle\Model\Afiliados (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Dsg\agenciaBundle\Model\Afiliados Clone of current object.
     * @throws PropelException
     */
